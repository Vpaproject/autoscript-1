...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
	clear
		echo "OpenVPN-install (github.com/Qeesya/OpenVPN-Install)"
		echo ""
	...
	clear
	echo "Welcome to the secure OpenVPN installer (github.com/Qeesya/OpenVPN-install)"
	echo ""
	...
	echo ""
	echo "See https://github.com/Qeesya/OpenVPN-install#encryption to learn more about "
